...
.setDescription('**m+kredi** komutu bölümlere ayrılır,Mesela para yatırmak istiyorsanız; \n **m+kredi yatır <tutar>** şeklinde olmalı.Mesela para çekmek istiyorsunuz; \n **m+kredi çek <tutar>** şeklinde olmalı.birine para atmak istiyorsanız; **m+kredi at <tutar>** şeklinde olmalı.')
.addField('Genellikle Sorulan Sorular:', '------------------------------')
.addField('Kredi Kartı Kredisini nasıl hesabıma geçirebilirim?:', '**m+kredi** yazarak hesabınıza geçirebilir,kredi kartınıza para yükleyebilirsiniz.')
.addField('Şirket Ne işe yarar?:', 'Gündelik olarak kazandığınız parayı arttırır.')
.addField('Günlük Paramı nasıl alırım?:', '**m+günlük** yazarak gündelik paranızı alabilirsiniz.')
.addBlankField()
.setTimestamp()
...
.setTitle('**Hata! :warning:**')
.setThumbnail('https://3.bp.blogspot.com/-0YAAfhbWbK8/V85bbvTEv7I/AAAAAAAAAhY/kUK836tzsSw6dXdfUtRgngFWJUB3CqExACEw/s1600/Revitlink%2BDamien%2BWArnings.png')
.setDescription('Merhaba,**'+message.member.user.username + '**, \n Anlaşılan para yatırmak istiyorsun.Ama ne kadar yatıracağını belirtmedin. \n **m+kredi yatır <miktar>** \n şeklinde tekrar yaz lütfen.')
.addField('Genellikle Sorulan Sorular:', '------------------------------')
.addField('Kredi Kartı Kredisini nasıl hesabıma geçirebilirim?:', '**m+kredi** yazarak hesabınıza geçirebilir,kredi kartınıza para yükleyebilirsiniz.')
.addField('Nasıl Para Kazanabilirim?:', 'BOTADINIZ size,gündelik olarak para verir.Bu değeri şirket açarak arttırabilirsiniz! şirket açmak için,**!şirket** kullanın.')
.addField('Şirket Ne işe yarar?:', 'Gündelik olarak kazandığınız parayı arttırır.')
.addField('Günlük Paramı nasıl alırım?:', '**m+günlük** yazarak gündelik paranızı alabilirsiniz.')
.addBlankField()
.setTimestamp()
...
.setThumbnail('https://image.flaticon.com/icons/svg/57/57426.svg')
.setDescription('Merhaba,**'+message.member.user.username + '**, \n Gerekli işlemleri başarıyla sisteme kaydettik.Detayları aşağıya bırakıyoruz! yine bekleriz :)')
.setFooter(client.user.username + ' Tüm Hakları Saklıdır..')
